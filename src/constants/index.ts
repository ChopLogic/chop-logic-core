import { LogicalSymbolHexCode, LogicalSymbolRawInput } from '../enums/logical-symbols';
...
export const PARENTHESES_LIST = [LogicalSymbolRawInput.OpenParenthesis, LogicalSymbolRawInput.CloseParenthesis];
