...
describe('isWellFormedFormula', () => {
  ...
  it('should return true for nested expressions', () => {
    expect(isWellFormedFormula(createPropExpression('((A & B) => C)'))).toBe(true);
    expect(isWellFormedFormula(createPropExpression('~((A & B) => C)'))).toBe(true);
    expect(isWellFormedFormula(createPropExpression('(((A & B) => C) <=> D)'))).toBe(true);
    expect(isWellFormedFormula(createPropExpression('~(~((~p & q) => ~~r) | ~s)'))).toBe(true);
  });
  ...
  it('should return false for unbalanced parentheses', () => {
    ...
    expect(isWellFormedFormula(createPropExpression('A & B)'))).toBe(false);
    expect(isWellFormedFormula(createPropExpression('(A & B))'))).toBe(false);
    expect(isWellFormedFormula(createPropExpression('((A & B) => C) <=> D)'))).toBe(false);
  });
