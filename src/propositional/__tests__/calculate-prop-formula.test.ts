...
describe('calculatePropFormula', () => {
  it('should evaluate a simple NOR operation', () => {
    ...
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, false] })).toBe(false);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, true] })).toBe(false);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [false, false] })).toBe(true);
  });
  ...
  it('should evaluate a more complex formula ((A & ~B) => C)', () => {
    ...
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, false, true] })).toBe(true);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, true, true] })).toBe(true);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, false, false] })).toBe(false);
  });
  ...
  it('should evaluate a more complex formula ((A & B) <=> (C | D))', () => {
    ...
    expect(calculatePropFormula({ formula, variablesMap, assignment: [false, false, false, false] })).toBe(true);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, true, true, true] })).toBe(true);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, false, false, true] })).toBe(false);
    expect(calculatePropFormula({ formula, variablesMap, assignment: [true, true, false, true] })).toBe(true);
  });
