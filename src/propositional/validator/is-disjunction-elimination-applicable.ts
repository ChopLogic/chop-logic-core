...
export function isDisjunctionEliminationApplicable(
	...
	return (
		(arePropFormulasStructurallyEqual([disjunct1, antecedent1]) &&
			arePropFormulasStructurallyEqual([disjunct2, antecedent2])) ||
		(arePropFormulasStructurallyEqual([disjunct1, antecedent2]) &&
			arePropFormulasStructurallyEqual([disjunct2, antecedent1]))
	);
}
